...
[![CI](https://github.com/PlatformStackPulse/tf-atom-iam-user-policy-attachment-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-iam-user-policy-attachment-aws/actions/workflows/ci.yml)
[![Latest Release](https://img.shields.io/github/v/release/PlatformStackPulse/tf-atom-iam-user-policy-attachment-aws)](https://github.com/PlatformStackPulse/tf-atom-iam-user-policy-attachment-aws/releases)
...
Terraform atom: AWS IAM User Policy Attachment - attaches a managed policy to an IAM user
...
| <a name="output_user"></a> [user](#output\_user) | Name of the user the policy is attached to |
<!-- END_TF_DOCS -->
